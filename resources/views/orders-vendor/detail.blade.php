...
@section('content')
    ...
    <div class="flex flex-col my-12 mx-[88px]">
        ...
        <div class="w-full pt-4 pb-12 mt-12 bg-white rounded-lg">
            ...
            @if (
                $order->order_status === \App\Models\Order::SHIPPED_BACK_APPLY_RETURN ||
                    $order->order_status === \App\Models\Order::COMPLETD_APPLY_RETURN)
                <div class="flex flex-col mx-7 text-[22px] mt-8">
                    <h1 class="font-bold text-[26px]">Apply Return Package Details</h1>
                    <div class="flex flex-row mt-[20px]">
                        <h1 class="w-[215px] font-semibold">
                            Customer Address
                        </h1>
        ...
        <div class="flex flex-row gap-16 mt-12 justify-center items-center">
            ...
            @elseif($order->order_status === \App\Models\Order::SHIPPED_BACK_APPLY_RETURN)
                <a href="{{ route('return-payment', ['id' => $order->id]) }}">
                        <div
                            class="w-[250px] flex items-center justify-center text-[20px] font-semibold h-[75px] rounded-lg bg-[#000000] text-[#D6E4E5] ">
