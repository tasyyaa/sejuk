...
<!--nav end--> '
'
    <form style="background: linear-gradient(180deg, #FFFFFF 0%, #F9F5F2 100%);" class="" method="post" action="{{ route('registervendor') }}"
        x-data="{
             password: '',
            confirmPassword: '',
...
{{--        </div>--}}
        <div class="flex flex-col items-center justify-center">
            ...
            <input type="password" placeholder="VERIFY PASSWORD"
                class="w-[600px] h-[102px] mt-12 ring-1 focus:border-none ring-black bg-white focus:outline-none text-[#BFB9B9] text-xl pl-8"
                type="password" name="password_confirmation" id="confirmPassword" x-model="confirmPassword" x-on:input="passwordsMatch = (password === confirmPassword)">
