...
<html lang="en">
    ...
    >
        ...
        <form action="/editcustsunting/store" method="POST"
        ...
        >
            ...
            <div
                x-show="invalid"
                class="fixed top-0 left-0 right-0 h-36 bg-white z-50"
                x-transition
                x-cloak
            >
                <div class="flex flex-col px-12 pt-4 pb-2">
                    ...
                    <p
                        class="ml-auto mt-4 px-8 py-0.5 border-2 shadow-xl border-b-4 border-b-slate-300 hove:brightness-75 cursor-pointer"
                        @click="invalid=false"
                    >
                        Ok
                    </p>
            ...
            <div class="flex flex-col w-full pr-36 p-6">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-col gap-3 text-xl">
                        <div class="flex flex-row items-center">
                            <label for="fullname" class="w-48 font-semibold"
                                >Full Name</label
                            >
                            <input
                                type="text"
                            ...
                            />
                            <img
                                src="images/edit-logo-light.png"
                                alt="edit-logo"
                                class="w-4 ml-4"
                            />
                        </div>
                        <div class="flex flex-row items-center">
                            <label for="email" class="w-48 font-semibold"
                                >Email</label
                            >
                            <input
                                type="email"
                                name="email"
                                id="email"
                                placeholder="Customerid@gmail.com"
                                class="border-[1px] border-black px-2 w-96 text-lg"
                                x-model="email"
                        ...
                        <div class="flex flex-row items-center">
                            <label for="phone" class="w-48 font-semibold"
                                >Phone Number</label
                            >
                            <input
                                type="text"
                ...
                <div class="flex flex-row justify-between w-full">
                    <div class="flex flex-col gap-6 w-full">
                        <div
                            class="flex flex-row text-lg items-center justify-between w-full"
                        >
                            <div class="flex flex-row items-center">
                                <img
                            ...
                            <div
                                class="flex flex-row text-lg pr-10 items-center"
                            >
                                <input
                                    type="text"
                                    name="mastercard"
