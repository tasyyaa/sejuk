    ...
    <div class="flex flex-col my-12 mx-[88px]">
        ...
        <div class="w-full h-screen mt-12 bg-white rounded-lg">
            ...
            <div class="flex flex-row gap-16 justify-center items-center">
                <a href="#send">
                    <div class="w-[196px] flex items-center justify-center text-xl font-semibold h-[51px] rounded-lg bg-[#497174] text-[#D6E4E5]">
                        <h1>Send Costume</h1>
                    </div>
                </a>
                <a href="#cancel">
                    <div class="w-[196px] flex items-center justify-center text-xl font-semibold h-[51px] rounded-lg bg-gray-200 ">
                        <h1>Cancel Order</h1>
                    </div>
                </a>
            </div>
