...
<body>
    ...
    <div class="flex flex-col my-12 mx-[88px]">
        ...
        <div class="flex flex-row gap-16 justify-center items-center bg-[#FFFFFF] w-full h-[100px]">
            <a href="#send">
                <div class="w-[196px] flex items-center justify-center text-xl font-semibold h-[51px] rounded-lg bg-black text-[#D6E4E5]">
                    <h1>Return Payment</h1>
                </div>
            </a>
            <a href="#cancel">
                <div class="w-[196px] bg-[#497174] flex items-center justify-center text-xl font-semibold h-[51px] rounded-lg text-[#D6E4E5] ">
