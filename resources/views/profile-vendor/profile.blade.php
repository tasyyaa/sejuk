        ...
        <div class="flex flex-col">
            <div class="flex flex-row items-center gap-6">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <a
                        href="{{route('profile.edit.vendor')}}"
            ...
            <div class="flex flex-col gap-3">
                <div class="flex flex-row text-xl">
                    <p class="w-48 font-semibold">Vendor Store</p>
                    <p class="text-lg">{{ $user->vendor_store }}</p>
                </div>
                <div class="flex flex-row text-xl">
                    <p class="w-48 font-semibold">Vendor Type</p>
                    <p class="text-lg">{{ $user->vendor_type }}</p>
                </div>
                <div class="flex flex-row text-xl">
                    <p class="w-48 font-semibold">Operation Hours</p>
                    <p class="text-lg">{{ $user->oprhours_open }} - {{ $user->oprhours_close }}</p>
                </div>
                <div class="flex flex-row text-xl">
            ...
            <div class="flex flex-col gap-6 w-full">
                <div class="flex flex-row text-lg items-center justify-between w-full">
                    ...
                    <div class="flex flex-row text-lg pr-10">
                        @if($user->vendor_Creditcardtype1)
                        <p class="w-64">{{ $user->vendor_Creditcardtype1 }}</p>
{{--                        <button class="underline font-light">Delete</button>--}}
                ...
                <div class="flex flex-row text-lg items-center justify-between w-full">
                    ...
                    <div class="flex flex-row text-lg pr-10">
                        @if($user->vendor_Creditcardtype2)
                            <p class="w-64">{{ $user->vendor_Creditcardtype2 }}</p>
{{--                            <button class="underline font-light">Delete</button>--}}
                        @else
                            <p class="w-64"> - </p>
                        @endif
        ...
        <div class="flex flex-col pt-10 pb-6 gap-1">
            ...
            <p class="text-lg">
                ...
                @if($user->vendor_homephone)
                    {{ $user->vendor_homephone }}
                @else
                    <span> - </span>
                @endif
            </p>
