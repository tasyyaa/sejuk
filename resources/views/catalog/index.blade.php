            ...
            <div class="flex flex-col rounded-sm bg-[#F9F5F2] w-[500px] h-[460px] ml-[45px] mt-[200px]">
                ...
                <div class="flex flex-row ml-[15px]">
                    <form action="/cart/store" class="" method="post" enctype="multipart/form-data">
                        @csrf
                        <input class="rounded-md h-[33px] focus:ring-0 focus:border-transparent bg-[#F9F5F2] border-none form-control" type="text" id="quantity"
                               aria-labelledby="required" name="quantity" placeholder="Enter your quantity"></form>
                </div>
