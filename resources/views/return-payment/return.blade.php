...
@section('content')
    ...
    <form action="{{ route('return-payment', ['id' => $order->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex flex-col">
                <div class="flex flex-row mt-[15px]">
                    ...
                    <div class="flex flex-col ml-[12px] ">
                        <p class="d-inline-block font-bold text-[#000000] text-[26px]">Return Payment For
                            {{ $order->user->name }}</p>
                    </div>
                </div>
                @if ($errors->any())
                    <div class=" text-[#FE4A4A] text-extrabold ml-[20px] mt-[8px]">
                        <p class="text-[20px]">Data is Invalid</p>
                    </div>
                @endif
                <div class="flex flex-col mt-[20px] ml-[15px]">
                    ...
                    <div class="flex flex-row mt-[25px]">
                        ...
                        <div class="flex flex-col ml-[38px]">
                            <input type="text" name="bank_account_name" class="border-black w-[200px] h-[35px]"
                    ...
                    <div class="flex flex-row mt-[25px]">
                        ...
                        <div class="flex flex-col ml-[15px]">
                            <input type="text" name="bank_account_number" class="border-black w-[200px] h-[35px]"
        ...
        <div class="bg-[#FFFFFF] w-[1100px] ml-[225px]  mr-[200px] mb-[60px] rounded-sm">
            <input type="Submit"
                class="bg-[#497174] text-[#d6e4e5] w-[250px] h-[40px] ml-[450px] mb-[30px] text-[20px] font-semibold rounded-sm"
                value="Submit">
        </div>
    </form>
@endsection
