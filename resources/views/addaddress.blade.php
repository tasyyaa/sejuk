...
@section('content')
    ...
    <form class="mx-[75px] flex flex-col gap-[48px]" action="/addaddress/store" method="post">
        {{ csrf_field() }}
        <div class="flex flex-col gap-2 font-semibold text-[#497174]">
            <label for="custaddress_name">Address Name</label>
            <select name="custaddress_name" id="custaddress_name">
        ...
        <div class="flex flex-col gap-2 font-semibold text-[#497174]">
            ...
            <input type="text" name="cust_address" required="required">
        </div >
        <div class="flex flex-col gap-2 font-semibold text-[#497174]">
            <label for="cust_city">City</label>
            <input type="text" name="cust_city" required="required">
        </div >
        <div class="flex flex-col gap-2 font-semibold text-[#497174]">
            <label for="cust_province">Province</label>
            <input type="text" name="cust_province" required="required">
        </div>
        <div class="flex flex-col gap-2 font-semibold text-[#497174]">
            <label for="cust_phonenumber">Telephone</label>
            <input type="text" name="cust_phonenumber" required="required">
        </div>
